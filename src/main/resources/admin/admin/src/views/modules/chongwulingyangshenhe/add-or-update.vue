        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwulingyang'">
                    <el-form-item class="select" v-if="type!='info'"  label="领养信息" prop="chongwulingyangId">
                        <el-select v-model="ruleForm.chongwulingyangId" :disabled="ro.chongwulingyangId" filterable placeholder="请选择领养信息" @change="chongwulingyangChange">
                            <el-option
                ...
                <el-col :span="12" v-if="sessionTable !='chongwulingyang' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chongwulingyangPhoto" label="动物图片" prop="chongwulingyangPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwulingyangPhoto" label="动物图片" prop="chongwulingyangPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="领养申请说明" prop="chongwurenlingshenheText">
                        <el-input type="textarea"  :readonly="ro.chongwurenlingshenheText" v-model="ruleForm.chongwurenlingshenheText" placeholder="领养申请说明"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwurenlingshenheText" label="领养申请说明" prop="chongwurenlingshenheText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwulingyangshenheYesnoTypes" label="审核状态" prop="chongwulingyangshenheYesnoTypes">
                        <el-input v-model="ruleForm.chongwulingyangshenheYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwulingyangshenheYesnoText" label="审核结果" prop="chongwulingyangshenheYesnoText">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   chongwulingyangId: [
                              { required: true, message: '领养信息不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   chongwurenlingshenheText: [
                              { required: true, message: '领养申请说明不能为空', trigger: 'blur' },
                          ],
                   chongwulingyangshenheYesnoTypes: [
