    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '电子邮箱': 'yonghuEmail',
                //本表字段
                     '领养申请说明': "chongwurenlingshenheText",
                     '审核状态': "chongwulingyangshenheYesnoTypes",
                     '审核结果': "chongwulingyangshenheYesnoText",
            },
